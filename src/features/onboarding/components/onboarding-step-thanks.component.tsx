    ...
    <Box style={styles.container} justifyContent="space-between">
      <Box gap={6} alignItems="center" pt={4}>
        <Box style={styles.iconWrapper} alignItems="center" justifyContent="center">
          <ThemedIcon name="Heart" size={36} color="accent" />
        </Box>
        ...
        <Box gap={4} alignItems="center">
          ...
          <ThemedText color="textSecondary" style={styles.textCenter}>
            Esse app foi feito com muito carinho por um programador solo. Cada linha de código, cada tela e cada detalhe foi pensado para te ajudar a encontrar o lugar certo na hora certa.
          </ThemedText>

          <ThemedText color="textSecondary" style={styles.textCenter}>
            Você não é só um usuário — é parte do que faz esse projeto existir. Espero que o Vibes te ajude a viver momentos incríveis.
          </ThemedText>
        </Box>

        <Box style={styles.signatureBox} gap={1} alignItems="center">
          <ThemedIcon name="Code" size={16} color="primary" />
          <ThemedText size="sm" color="textTertiary" style={styles.textCenter}>
